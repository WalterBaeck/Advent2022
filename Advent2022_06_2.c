...
int main(int Arguments, char* Argument[])
{
	...
	/* Operation */
	/*************/
	for (InputPos=13; InputPos<InputLen; InputPos++)
	{
		int Pos1,Pos2;
		int FoundDuplicate=0;
		for (Pos1=-13; Pos1<0; Pos1++)
			for (Pos2=-12; Pos2<=0; Pos2++)
			{
	...
	printf("Unique 14-char substring found after InputPos %d: %s\n", InputPos+1, InputLine+InputPos-13);
	return 0;
}
